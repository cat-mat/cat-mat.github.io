    ...
    <div className="min-h-screen wildflower-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="wildflower-header text-4xl mb-4">🔒 Privacy Policy</h1>
        ...
        <div className="meadow-card p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">🔐 Data Storage & Security</h3>
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">📊 What Data We Collect</h3>
              <ul className="space-y-2 text-gray-700">
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">🛡️ Your Rights & Control</h3>
              <ul className="space-y-2 text-gray-700">
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">📱 Offline Functionality</h3>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              ...
              <p className="text-blue-700 text-sm mt-1">
                This privacy policy applies to all users of "What Even With My Hot Self?!" 
                regardless of how you access the application.
              </p>
            </div>
          </div>
        </div>
